...
export default function Home() {
    ...
    const handleForm = () => {
        btnText==='null' ? setBtnValue("+ Add Button"):"+ Add Button";
        console.log(url);
        console.log(size);
        console.log(btnColor);
        console.log(style);
        setOpen(false)
        btnRef.current.style.border="3px solid red"
        setBtnValue(btnText)
        ...
        <div className="hero-section">
            <header className='my-section '>
                ...
                <div className='text-center'>
                    {button && <button ref={btnRef} className='btn' value="+ Add Button" onClick={() => {
                        setOpen(true)
                    }}>{btnValue}</button>}
                    {
                        open && (
                            <div className="pop">
                                ...
                                <input type="text" value={url} name="url" id="url" onChange={(e) => setUrl(e.target.value)} />
                                <br /><br />
